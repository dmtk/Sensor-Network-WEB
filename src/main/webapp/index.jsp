...
<html>
    <head>
        ...
        <meta class="os-tdn" http-equiv="Content-Language" content="en">
        <meta class="os-tdn" property="og:locale" content="ru"><link href="onesky-client.css" type="text/css" rel="stylesheet"><link href="Dashboard%20Template%20for%20Bootstrap_files/bootstrap_in-context.css" type="text/css" rel="stylesheet">
        </head>
